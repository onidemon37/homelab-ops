# Bootstraps the Flux Operator + FluxInstance for the Atlantis Vault cluster.
...
module "flux_operator_bootstrap" {
  ...
  gitops_resources = {
    instance_yaml = file("${path.root}/../../../clusters/prod/atlantis/flux-system/flux-instance.yaml")
    operator_chart = {
