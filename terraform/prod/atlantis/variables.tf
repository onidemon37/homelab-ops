variable "kubeconfig_path" {
  description = "Path to the kubeconfig file used to reach the Atlantis cluster"
  type        = string
  default     = "~/.kube/config"
}

variable "kube_context" {
  description = "kubeconfig context for the Atlantis cluster"
  type        = string
  default     = "atlantis-vault"
}
